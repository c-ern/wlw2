...
class FacilitiesControllerTest < ActionController::TestCase
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post :create, facility: { address: @facility.address, latitude: @facility.latitude, longitude: @facility.longitude, name: @facility.name }
    end
  ...
  test "should update facility" do
    put :update, id: @facility, facility: { address: @facility.address, latitude: @facility.latitude, longitude: @facility.longitude, name: @facility.name }
    assert_redirected_to facility_path(assigns(:facility))
  end
