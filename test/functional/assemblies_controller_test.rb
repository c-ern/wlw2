...
class AssembliesControllerTest < ActionController::TestCase
  ...
  test "should create assembly" do
    assert_difference('Assembly.count') do
      post :create, assembly: { car_configuration_id: @assembly.car_configuration_id, facility_id: @assembly.facility_id }
    end
  ...
  test "should update assembly" do
    put :update, id: @assembly, assembly: { car_configuration_id: @assembly.car_configuration_id, facility_id: @assembly.facility_id }
    assert_redirected_to assembly_path(assigns(:assembly))
  end
