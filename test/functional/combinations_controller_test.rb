...
class CombinationsControllerTest < ActionController::TestCase
  ...
  test "should create combination" do
    assert_difference('Combination.count') do
      post :create, combination: { car_body_style_id: @combination.car_body_style_id, product_id: @combination.product_id }
    end
  ...
  test "should update combination" do
    put :update, id: @combination, combination: { car_body_style_id: @combination.car_body_style_id, product_id: @combination.product_id }
    assert_redirected_to combination_path(assigns(:combination))
  end
